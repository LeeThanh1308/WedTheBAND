...
const app = {
  ...
  songs: [
    ...
    },
    {
      ...
      image: "./asset/image/Tha Phương Tuổi 18.jpg",
    },
    {
            ...
            <div class="listsongs ${
              index === this.currentIndex ? "active-song" : ""
                ...
                <div class="list-name">
                    <img src="${
                      song.image
                    }" alt="" width="40px" height="40px" style="border-radius: 4px;">
  ...
  handleEvents: function () {
    ...
    audio.onplay = () => {
      ...
      document
        .querySelector(".listsongs.active-song")
  ...
  scrollToActiveSong: function () {
    setTimeout(() => {
      $(".listsongs.active-song").scrollIntoView({
        behavior: "smooth",
        block: "center",
        inline: "nearest",
      });
